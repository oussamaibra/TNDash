...
const CollectionModalAddEdit = (props) => {
  ...
  const handleonfinish = async (val) => {
    ...
    if (props.type === "EDIT") {
      await axios
        .put("https://www.tnprime.shop:6443/api/v1/collection/" + values.id, {
          name: values?.name,
      ...
      await axios
        .post("https://www.tnprime.shop:6443/api/v1/collection", {
          name: values?.name,
          description: values?.description,
          thumbnailImage: img[0],
        })
...
export default CollectionModalAddEdit;
